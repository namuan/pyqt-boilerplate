...
convert $(ls "${output_name}".iconset/icon_*.png) resources/icons/app.ico

rm -R "$output_name.iconset"
mv "$output_name".icns resources/icons/

$inkscape -z -e "$PWD/resources/images/${output_name}.png" -w 512 -h 512 "$svg_file"
$inkscape -z -e "$PWD/resources/images/${output_name}-logo.png" -w 100 -h 80 "$svg_file"